...
export default function Footer() {
    return (
        <div className="flex flex-col md:flex-col items-center justify-between w-full h-auto p-10 z-10">
            <div className="oxanium oxanium-semibold text-center md:text-left mb-6 md:mb-0">
                <h1 className="text-sm md:text-md lg:text-4xl">Here's my social media!</h1>
            </div>
